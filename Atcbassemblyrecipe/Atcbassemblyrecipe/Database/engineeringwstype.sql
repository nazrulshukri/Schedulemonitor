...
--   this table                     -> SAWING reads SAWING
--   ENGINEERING by LOTNUMBER       -> that lot's SAWING value
...
(
  ...
  COLUMN_NAME  VARCHAR2(30 BYTE) NOT NULL,  -- SAWING | WIREBOND | MARKER
...
-- Sawing machines.
INSERT INTO OCAPSYS.ENGINEERINGWSTYPE (wstype, column_name) VALUES ('SAWING',    'SAWING');
INSERT INTO OCAPSYS.ENGINEERINGWSTYPE (wstype, column_name) VALUES ('WAOI',      'SAWING');

-- Wirebond, and the die/clip attach machines that feed it.
INSERT INTO OCAPSYS.ENGINEERINGWSTYPE (wstype, column_name) VALUES ('DIEBOND',   'WIREBOND');
INSERT INTO OCAPSYS.ENGINEERINGWSTYPE (wstype, column_name) VALUES ('ASMWB',     'WIREBOND');
INSERT INTO OCAPSYS.ENGINEERINGWSTYPE (wstype, column_name) VALUES ('ASMWBM',    'WIREBOND');
INSERT INTO OCAPSYS.ENGINEERINGWSTYPE (wstype, column_name) VALUES ('ASMWBD',    'WIREBOND');
INSERT INTO OCAPSYS.ENGINEERINGWSTYPE (wstype, column_name) VALUES ('ADAT',      'WIREBOND');

-- Marking, moulding and trim/form.
INSERT INTO OCAPSYS.ENGINEERINGWSTYPE (wstype, column_name) VALUES ('MARKER',    'MARKER');
INSERT INTO OCAPSYS.ENGINEERINGWSTYPE (wstype, column_name) VALUES ('2DMARKER',  'MARKER');
INSERT INTO OCAPSYS.ENGINEERINGWSTYPE (wstype, column_name) VALUES ('MOULD',     'MARKER');
INSERT INTO OCAPSYS.ENGINEERINGWSTYPE (wstype, column_name) VALUES ('TRIMFORM',  'MARKER');
INSERT INTO OCAPSYS.ENGINEERINGWSTYPE (wstype, column_name) VALUES ('PLATING',   'MARKER');
